...
import { PATHS, INITIAL_USER_STATE } from '../constants';
...
interface DashboardProps {
  ...
  currentPath: PathId;
  completedModules?: string[]; // Add this prop
}
...
export const Dashboard: React.FC<DashboardProps> = ({ 
  ...
  const pathModuleIds = activePath.modules.map(m => m.id);
  const isPathComplete = pathModuleIds.every(id => completedModules.includes(id)) && pathModuleIds.length > 0;
  ...
  const renderPathHeader = () => {
    switch (currentPath) {
      case PathId.SOVEREIGN:
        return (
          <div className="bg-gradient-to-r from-surface-dark to-surface-highlight border border-white/10 rounded-2xl p-6 md:p-8 relative overflow-hidden group">
            <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 relative z-10 gap-4">
              <div>
                ...
                <h3 className="text-4xl md:text-5xl font-bold text-white tracking-tight font-display">{INITIAL_USER_STATE.reputation.toLocaleString()}</h3>
              </div>
            ...
            <div className="relative z-10 max-w-2xl">
              <div className="flex justify-between text-xs text-text-muted mb-2 font-bold tracking-wide">
                <span>CURRENT RANK: {INITIAL_USER_STATE.rank.toUpperCase()}</span>
                <span>NEXT: CITADEL KEEPER</span>
              </div>
              <div className="h-3 w-full bg-black/40 rounded-full overflow-hidden border border-white/5">
                <div className="h-full bg-gradient-to-r from-primary to-orange-600 w-[75%] shadow-[0_0_15px_rgba(247,147,26,0.6)] relative overflow-hidden">
      ...
      case PathId.WALLET_MASTERY:
        return (
          <div className="bg-gradient-to-br from-blue-900/20 to-surface-highlight border border-blue-500/20 rounded-2xl p-6 md:p-8 relative overflow-hidden group">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 relative z-10 gap-4">
              ...
              {isPathComplete ? renderStressTestButton() : (
                  <div className="flex gap-4">
                    <div className="bg-background-dark/50 p-3 rounded-xl border border-white/5 backdrop-blur-sm">
                        <div className="text-xs text-text-muted uppercase font-bold">Cold Storage</div>
                        <div className="text-success font-bold flex items-center gap-1"><span className="size-2 rounded-full bg-success animate-pulse"></span> Active</div>
                    </div>
                    <div className="bg-background-dark/50 p-3 rounded-xl border border-white/5 backdrop-blur-sm">
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-2 text-sm text-text-muted">
                    ...
                    <span>Seed Phrase Backup Verified</span>
                    <span className="mx-2">•</span>
                    <span className="material-symbols-outlined text-success">check_circle</span>
                    <span>Passphrase Enabled</span>
                </div>
            </div>
            <div className="absolute right-0 top-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity duration-500">
      ...
      case PathId.PROTOCOL_ENGINEER:
        return (
          <div className="bg-black border border-green-500/20 rounded-2xl p-6 md:p-8 relative overflow-hidden group">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 relative z-10 gap-4">
              ...
              {isPathComplete ? renderStressTestButton() : (
                <div className="grid grid-cols-2 gap-4 font-mono text-sm">
                    ...
                    <div className="text-right">
                        <div className="text-text-muted">Mempool</div>
                        <div className="text-white font-bold">42 vMB</div>
                    </div>
                    <div className="text-right">
                        <div className="text-text-muted">Peers (In/Out)</div>
      ...
      case PathId.LIGHTNING_OPERATOR:
        return (
          <div className="bg-gradient-to-br from-purple-900/20 to-surface-highlight border border-purple-500/20 rounded-2xl p-6 md:p-8 relative overflow-hidden group">
            ...
            <div className="relative z-10">
                <div className="h-1.5 w-full bg-background-dark rounded-full overflow-hidden flex">
                    ...
                    <div className="h-full bg-text-muted w-[40%]"></div>
                </div>
                <div className="flex justify-between text-[10px] text-text-muted mt-1 font-bold uppercase">
                    <span>Inbound: 3.1M</span>
                    <span>Outbound: 2.1M</span>
                </div>
            </div>
            <div className="absolute right-0 top-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity duration-500">
      ...
      case PathId.SOVEREIGN_MERCHANT:
        return (
          <div className="bg-gradient-to-br from-amber-900/20 to-surface-highlight border border-amber-500/20 rounded-2xl p-6 md:p-8 relative overflow-hidden group">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 relative z-10 gap-4">
              ...
              {!isPathComplete && (
                  <div className="flex gap-4">
                      <div className="text-right">
                          <div className="text-xs text-text-muted uppercase font-bold">Invoices</div>
                          <div className="text-white font-bold">128 Paid</div>
                      </div>
                      <div className="text-right">
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-3">
                     <span className="px-2 py-1 rounded bg-amber-500/10 text-amber-500 border border-amber-500/20 text-[10px] font-bold uppercase">BTCPay Active</span>
                     <span className="px-2 py-1 rounded bg-white/5 text-text-muted border border-white/10 text-[10px] font-bold uppercase">MemPool: Low</span>
                </div>
            </div>
            <div className="absolute right-0 top-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity duration-500">
      ...
      case PathId.SECURITY_PRACTITIONER:
        return (
          <div className="bg-gradient-to-br from-red-900/20 to-surface-highlight border border-red-500/20 rounded-2xl p-6 md:p-8 relative overflow-hidden group">
              ...
              {!isPathComplete && (
                  <div className="flex gap-4">
                      <div className="bg-red-500/10 p-3 rounded-xl border border-red-500/20">
                          <div className="text-xs text-red-400 uppercase font-bold">Attack Vectors</div>
                          <div className="text-white font-bold">0 Detected</div>
                      </div>
                  </div>
              )}
            </div>
            <div className="relative z-10">
                <div className="flex items-center gap-4 text-xs font-bold text-text-muted">
                    <span className="flex items-center gap-1"><span className="size-2 rounded-full bg-success"></span> Air-Gap Integrity</span>
                    <span className="flex items-center gap-1"><span className="size-2 rounded-full bg-success"></span> Canary Valid</span>
                </div>
            </div>
            <div className="absolute right-0 top-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity duration-500">
      ...
      case PathId.P2P_MARKET:
        return (
          <div className="bg-gradient-to-br from-teal-900/20 to-surface-highlight border border-teal-500/20 rounded-2xl p-6 md:p-8 relative overflow-hidden group">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 relative z-10 gap-4">
              ...
              {!isPathComplete && (
                  <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="text-right">
                          <div className="text-xs text-text-muted uppercase font-bold">Disputes</div>
                          <div className="text-success font-bold">0 Active</div>
                      </div>
                  </div>
              )}
            </div>
            <div className="relative z-10">
                <div className="h-2 w-full bg-surface-dark rounded-full overflow-hidden border border-white/5">
                    <div className="h-full bg-teal-500 w-[95%] shadow-[0_0_10px_rgba(20,184,166,0.5)]"></div>
                </div>
                <p className="text-[10px] text-text-muted mt-1 uppercase font-bold tracking-wide">Bisq / Robosats / HodlHodl Aggregated Score</p>
            </div>
            <div className="absolute right-0 top-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity duration-500">
      ...
      case PathId.COMMUNITY_BUILDER:
        return (
          <div className="bg-gradient-to-br from-pink-900/20 to-surface-highlight border border-pink-500/20 rounded-2xl p-6 md:p-8 relative overflow-hidden group">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 relative z-10 gap-4">
              ...
              {!isPathComplete && (
                  <div className="flex gap-4">
                      <div className="bg-pink-500/10 p-3 rounded-xl border border-pink-500/20 text-center min-w-[80px]">
                          <div className="text-xs text-pink-400 uppercase font-bold">Nodes</div>
                          <div className="text-white font-bold">15</div>
                      </div>
                      <div className="bg-pink-500/10 p-3 rounded-xl border border-pink-500/20 text-center min-w-[80px]">
                          <div className="text-xs text-pink-400 uppercase font-bold">Meetups</div>
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-2 text-xs font-bold text-text-muted">
                    <span className="material-symbols-outlined text-pink-400">hub</span>
                    <span>Citadel Construction In Progress...</span>
                </div>
            </div>
            <div className="absolute right-0 top-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity duration-500">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <div className="hidden md:flex p-6 md:px-8 items-center justify-between sticky top-0 bg-background-dark/95 backdrop-blur z-20 border-b border-white/5">
                        ...
                        {PATHS.map(path => (
                           ...
                           >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="text-[10px] opacity-70 truncate">{path.modules.length} Modules • {path.activeLearners} Learners</div>
                              </div>
                              {currentPath === path.id && <span className="material-symbols-outlined text-sm text-primary">check_circle</span>}
                           </button>
                        ))}
                      </div>
                  </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center justify-center size-10 rounded-lg bg-surface-highlight text-text-muted hover:text-white cursor-pointer transition-colors border border-white/5 hover:border-white/20">
                ...
                >
                     <div className="text-right hidden lg:block">
                        <h3 className="text-sm font-bold text-white leading-none">Satoshi_Vz</h3>
                        <p className="text-[10px] text-text-muted font-mono uppercase mt-1">{INITIAL_USER_STATE.rank}</p>
                     </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-8 custom-scrollbar">
            ...
            <div className="max-w-5xl">
                ...
                <div className="space-y-4 relative pl-4 md:pl-0">
                    {/* Vertical Timeline Line (Desktop only usually, but good here) */}
                    <div className="absolute left-[39px] top-4 bottom-8 w-0.5 bg-gradient-to-b from-primary/50 to-transparent hidden md:block"></div>
                            ...
                            <div key={mod.id} className="group relative flex flex-col md:flex-row gap-4 md:gap-8 md:items-start animate-in slide-in-from-bottom-2 fade-in duration-500" style={{animationDelay: `${idx * 100}ms`}}>
                                ...
                                <div className="hidden md:flex flex-col items-center mt-6 relative z-10">
                                    {isCompleted ? (
                                        ...
                                        <div className="size-8 rounded-full bg-background-dark border-2 border-primary flex items-center justify-center text-primary shadow-[0_0_15px_rgba(247,147,26,0.6)]">
                                ...
                                {/* Card */}
                                <div className={`flex-1 rounded-2xl p-5 md:p-6 border transition-all duration-300 ${
                                    mod.status === 'LOCKED' 
